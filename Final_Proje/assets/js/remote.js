...
g.Xc(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.Ab(a)},vBa=function(a,b){var c=g.Cd("SCRIPT");
...
g.Zc(c,g.ae("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},wBa=function(){var a=uBa(),b=window.document.getElementById(a),c=b&&g.bF(b,"loaded");
...
a.od&&(c=null);var d=(0,g.A)(a.CV,a);c||(c=new g.vm("//www.google.com/images/cleardot.gif"),P6(c));LBa(c.toString(),1E4,d)}else q7(2);bCa(a,b)},bCa=function(a,b){a.g=0;
